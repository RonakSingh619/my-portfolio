    ...
    <div className='flex justify-center items-center'>
      ...
      <div className='flex flex-col md:flex-row w-full'>
        ...
        <div data-aos-once="true" data-aos='fade-right' className='w-full md:w-[50%]'>
          <label className='p-0 text-white text-[46px] md:text-[64px] font-serif font-bold'>Got a project in <label className='w-[60%] p-0 text-[#00ADB5] text-[46px] md:text-[64px] font-serif font-bold'>mind?</label><br /></label>
