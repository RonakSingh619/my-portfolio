  ...
  return (
    <div className=" flex flex-col">
        ...
        {/* bg-white/5 p-2 backdrop-blur-sm */}
            <div className='flex'>
              <label className='p-0 text-white text-[46px] md:text-[64px] font-serif font-bold'>My <label className='w-[60%] p-0 text-[#00ADB5] text-[46px] md:text-[64px] font-serif font-bold'>Education</label><br /></label>
            </div>
        </div>

        <div className='flex flex-col justify-center mx-auto mt-[3rem] mb-[13rem] w-full md:w-fit'>
            {educationDetails.map(({ title, desc, icon }, i) => 
                <div key={title} data-aos="fade-up" className='w-full md:w-[500px] h-[350px] md:h-[500px] rounded-2xl bg-white mb-[5rem] flex flex-col group cursor-pointer shadow-inner' tabIndex={0}>
