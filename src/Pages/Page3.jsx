  ...
  return (
    <div className="md:h-screen md:mb-0 mb-[5rem] flex">
        ...
        {/* bg-white/5 p-2 backdrop-blur-sm */}
            <div className='flex'>
              <label className='p-0 text-white text-[46px] md:text-[64px] font-serif font-bold'>My recent <label className='w-[60%] p-0 text-[#00ADB5] text-[46px] md:text-[64px] font-serif font-bold'>works</label><br /></label>
            </div>

            {/* ----------Tabs---------- */}
            <div className='mt-[2rem] w-full'>
              {/* Head */}
              <div className='flex py-5 md:py-0 overflow-x-scroll md:overflow-x-clip'>
